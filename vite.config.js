    ...
    build: {
        rollupOptions: {
            input: {
                ...
                agrocentro: resolve(__dirname, 'agrocentro/index.html'),
                agrocentroCheckout: resolve(__dirname, 'agrocentro/checkout.html'),
                agrocentroDashboard: resolve(__dirname, 'agrocentro/dashboard.html'),
